...
const Testimonial = () => {
  ...
  return (
    <div className="bg-cover bg-center my-8" style={{ backgroundImage: `url(${bgImage})` }}>
    <div className='bg-black bg-opacity-70'>
    <div className="relative flex p-8 max-w-[1100px] mx-auto py-20">
      ...
      <div className="w-1/2 pr-8 relative z-10">
        ...
        Embarking on a journey with this Wanderlust is an unparalleled experience. Every destination is a masterpiece.
        </p>
      </div>

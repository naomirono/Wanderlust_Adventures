        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 lg:ml-8">
            ...
            <div className="flex flex-col lg:flex-row mb-6">
              <div className="w-full lg:w-1/2 lg:mr-4 border-2 border-orange-500 rounded-[8px] flex items-start p-2">
              ...
              <div className='w-full lg:w-1/2 border-2 border-orange-500 rounded-[8px] flex items-start p-2 mt-4 lg:mt-0'>
